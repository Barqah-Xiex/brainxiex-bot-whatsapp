...
module.exports = config => {
    ...
    func.userAgent = function ({Nama_Bot = "UNKNOWN BOT",Nomor_Bot = NaN,Nama_Owner = "UNKNOWN",Nomor_Owner=NaN} = config) {
    ...
    func.isWhatsapp = func.isPN = func.isPn = (str) => str.includes('@s.whatsapp.net');
    ...
    func.smsg = (conn, messagena, store) => {
        ...
        if (m.key) {
            ...
            m.senderLid = store.getLid(m.senderLid) || store.getLid(m.senderJid) || m.senderLid;
            m.senderJid = store.getPN(m.senderLid) || store.getPN(m.senderJid) || m.senderJid;
        ...
        if (m.message) {
            ...
            m.isEdited = (m.mtype === 'protocolMessage' && m.message.protocolMessage.type == 14);
            m.isDeleted = (m.mtype === 'protocolMessage' && m.message.protocolMessage.type == "REVOKE");
            m.body = (m.mtype === 'conversation') ? m.message.conversation : 
                        (m.mtype === 'reactionMessage') ? m.message.reactionMessage.text : 
                        m.isDeleted ? `` : 
                        m.isEdited ? m.message.protocolMessage.editedMessage.protocolMessage.editedMessage.extendedTextMessage.text : 

...
async function message(sock, m, store) {
    ...
    const ai_answer = await ai(arg,m,sock,"brainxiex");
    ...
    // const {extendedTextMessage} = await sock.banner(id,{image:`${baseURL}/api/image/banner?font_size=150&apikey=${apikey}&text=brainxiex`},{},false);
    // await sock.sendInteractiveMessage(id,`\n${ai_answer}\n`,'powered By Brainxiex',Nama_Bot,'',null,sock.InteractiveButton(buttons),m,extendedTextMessage);
